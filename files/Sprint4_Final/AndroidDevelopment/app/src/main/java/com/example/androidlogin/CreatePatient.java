...
//This activity lets the user add a patient. Their general info can be set in here.
//Its the 1st of 4 activities that create a patient as a whole.
//Other activities in order are: cp_pro_background, cp_ethnicity_information and cp_geo_epi_factors
