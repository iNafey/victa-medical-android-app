...
//This activity lets the user to set the Geographical/Epidemiological factors of a patient they are creating
//Also contains code for pushing the Patient object to firebase
