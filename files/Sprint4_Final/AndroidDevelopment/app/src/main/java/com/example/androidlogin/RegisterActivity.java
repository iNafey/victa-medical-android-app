...
//The register activity lets the user create an account which is stored in firebase realtime database
//The user is NOT assign access roles here! They have to manually be set via firebase console
